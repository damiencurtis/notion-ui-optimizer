...
An unofficial custom userscript that streamlines [Notion.so’s](https://www.notion.so/) web UI, NOT affiliated with Notion. The script minimizing distractions and maximizing space for a crisp user experience. 
